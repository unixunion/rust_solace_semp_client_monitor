...
pub struct ClientApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> ClientApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> ClientApiClient<C> {
        ClientApiClient {
...
impl<C: hyper::client::Connect>ClientApi for ClientApiClient<C> {
    fn get_msg_vpn_clients(&self, msg_vpn_name: &str, count: i32, cursor: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnClientsResponse, Error = Error<serde_json::Value>>> {
