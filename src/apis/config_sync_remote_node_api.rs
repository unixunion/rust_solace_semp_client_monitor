...
pub struct ConfigSyncRemoteNodeApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> ConfigSyncRemoteNodeApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> ConfigSyncRemoteNodeApiClient<C> {
        ConfigSyncRemoteNodeApiClient {
            configuration: configuration,
        }
    }
}

pub trait ConfigSyncRemoteNodeApi {
...
impl<C: hyper::client::Connect>ConfigSyncRemoteNodeApi for ConfigSyncRemoteNodeApiClient<C> {
    fn get_msg_vpn_config_sync_remote_nodes(&self, msg_vpn_name: &str, count: i32, cursor: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnConfigSyncRemoteNodesResponse, Error = Error<serde_json::Value>>> {
