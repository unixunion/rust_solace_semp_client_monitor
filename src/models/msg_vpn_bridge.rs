...
impl MsgVpnBridge {
  ...
  pub fn with_average_rx_byte_rate(mut self, average_rx_byte_rate: i64) -> MsgVpnBridge {
    self.average_rx_byte_rate = Some(average_rx_byte_rate);
    self
  }
  ...
  pub fn with_average_rx_msg_rate(mut self, average_rx_msg_rate: i64) -> MsgVpnBridge {
    self.average_rx_msg_rate = Some(average_rx_msg_rate);
    self
  }
  ...
  pub fn with_average_tx_byte_rate(mut self, average_tx_byte_rate: i64) -> MsgVpnBridge {
    self.average_tx_byte_rate = Some(average_tx_byte_rate);
    self
  }
  ...
  pub fn with_average_tx_msg_rate(mut self, average_tx_msg_rate: i64) -> MsgVpnBridge {
    self.average_tx_msg_rate = Some(average_tx_msg_rate);
    self
  }
  ...
  pub fn with_control_rx_byte_count(mut self, control_rx_byte_count: i64) -> MsgVpnBridge {
    self.control_rx_byte_count = Some(control_rx_byte_count);
    self
  }
  ...
  pub fn with_control_rx_msg_count(mut self, control_rx_msg_count: i64) -> MsgVpnBridge {
    self.control_rx_msg_count = Some(control_rx_msg_count);
    self
  }
  ...
  pub fn with_control_tx_byte_count(mut self, control_tx_byte_count: i64) -> MsgVpnBridge {
    self.control_tx_byte_count = Some(control_tx_byte_count);
    self
  }
  ...
  pub fn with_control_tx_msg_count(mut self, control_tx_msg_count: i64) -> MsgVpnBridge {
    self.control_tx_msg_count = Some(control_tx_msg_count);
    self
  }
  ...
  pub fn with_data_rx_byte_count(mut self, data_rx_byte_count: i64) -> MsgVpnBridge {
    self.data_rx_byte_count = Some(data_rx_byte_count);
    self
  }
  ...
  pub fn with_data_rx_msg_count(mut self, data_rx_msg_count: i64) -> MsgVpnBridge {
    self.data_rx_msg_count = Some(data_rx_msg_count);
    self
  }
  ...
  pub fn with_data_tx_byte_count(mut self, data_tx_byte_count: i64) -> MsgVpnBridge {
    self.data_tx_byte_count = Some(data_tx_byte_count);
    self
  }
  ...
  pub fn with_data_tx_msg_count(mut self, data_tx_msg_count: i64) -> MsgVpnBridge {
    self.data_tx_msg_count = Some(data_tx_msg_count);
    self
  }
  ...
  pub fn with_discarded_rx_msg_count(mut self, discarded_rx_msg_count: i32) -> MsgVpnBridge {
    self.discarded_rx_msg_count = Some(discarded_rx_msg_count);
    self
  }
  ...
  pub fn with_discarded_tx_msg_count(mut self, discarded_tx_msg_count: i32) -> MsgVpnBridge {
    self.discarded_tx_msg_count = Some(discarded_tx_msg_count);
    self
  }
  ...
  pub fn with_login_rx_msg_count(mut self, login_rx_msg_count: i64) -> MsgVpnBridge {
    self.login_rx_msg_count = Some(login_rx_msg_count);
    self
  }
  ...
  pub fn with_login_tx_msg_count(mut self, login_tx_msg_count: i64) -> MsgVpnBridge {
    self.login_tx_msg_count = Some(login_tx_msg_count);
    self
  }
  ...
  pub fn with_msg_spool_rx_msg_count(mut self, msg_spool_rx_msg_count: i64) -> MsgVpnBridge {
    self.msg_spool_rx_msg_count = Some(msg_spool_rx_msg_count);
    self
  }
  ...
  pub fn with_rx_byte_count(mut self, rx_byte_count: i64) -> MsgVpnBridge {
    self.rx_byte_count = Some(rx_byte_count);
    self
  }
  ...
  pub fn with_rx_byte_rate(mut self, rx_byte_rate: i64) -> MsgVpnBridge {
    self.rx_byte_rate = Some(rx_byte_rate);
    self
  }
  ...
  pub fn with_rx_msg_count(mut self, rx_msg_count: i32) -> MsgVpnBridge {
    self.rx_msg_count = Some(rx_msg_count);
    self
  }
  ...
  pub fn with_rx_msg_rate(mut self, rx_msg_rate: i64) -> MsgVpnBridge {
    self.rx_msg_rate = Some(rx_msg_rate);
    self
  }
  ...
  pub fn with_tx_byte_count(mut self, tx_byte_count: i64) -> MsgVpnBridge {
    self.tx_byte_count = Some(tx_byte_count);
    self
  }
  ...
  pub fn with_tx_byte_rate(mut self, tx_byte_rate: i64) -> MsgVpnBridge {
    self.tx_byte_rate = Some(tx_byte_rate);
    self
  }
  ...
  pub fn with_tx_msg_count(mut self, tx_msg_count: i64) -> MsgVpnBridge {
    self.tx_msg_count = Some(tx_msg_count);
    self
  }
  ...
  pub fn with_tx_msg_rate(mut self, tx_msg_rate: i64) -> MsgVpnBridge {
    self.tx_msg_rate = Some(tx_msg_rate);
    self
  }
