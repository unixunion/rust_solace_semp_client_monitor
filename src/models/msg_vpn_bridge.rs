...
pub struct MsgVpnBridge {
  ...
  /// The establisher of the Bridge connection as: local or remote.
  ...
  /// The state of the inbound connection from the Bridge.
  ...
  /// The state of the outbound connection to the Bridge.
  ...
  /// The priority for deliver-to-one (DTO) messages transmitted from the remote Message VPN. The allowed values and their meaning are:  <pre> \"p1\" - Priority 1 (highest). \"p2\" - Priority 2. \"p3\" - Priority 3. \"p4\" - Priority 4 (lowest). \"da\" - Deliver Always. </pre> 
