...
impl MsgVpnClientTxFlow {
  pub fn new() -> MsgVpnClientTxFlow {
    MsgVpnClientTxFlow {
      client_name: None,
      endpoint_name: None,
      endpoint_type: None,
  ...
  pub fn with_client_name(mut self, client_name: String) -> MsgVpnClientTxFlow {
    self.client_name = Some(client_name);
    self
  }
  ...
  pub fn with_endpoint_name(mut self, endpoint_name: String) -> MsgVpnClientTxFlow {
    self.endpoint_name = Some(endpoint_name);
    self
  }
  ...
  pub fn with_endpoint_type(mut self, endpoint_type: String) -> MsgVpnClientTxFlow {
    self.endpoint_type = Some(endpoint_type);
    self
  }
  ...
  pub fn with_flow_id(mut self, flow_id: i64) -> MsgVpnClientTxFlow {
    self.flow_id = Some(flow_id);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnClientTxFlow {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
