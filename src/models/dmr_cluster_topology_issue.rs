...
pub struct DmrClusterTopologyIssue {
  ...
  #[serde(rename = "topologyIssue", skip_serializing_if="Option::is_none")]
  topology_issue: Option<String>
}

impl DmrClusterTopologyIssue {
  pub fn new() -> DmrClusterTopologyIssue {
  ...
  pub fn with_dmr_cluster_name(mut self, dmr_cluster_name: String) -> DmrClusterTopologyIssue {
    self.dmr_cluster_name = Some(dmr_cluster_name);
    self
  }
  ...
  pub fn set_topology_issue(&mut self, topology_issue: String) {
    self.topology_issue = Some(topology_issue);
  }

  pub fn with_topology_issue(mut self, topology_issue: String) -> DmrClusterTopologyIssue {
    self.topology_issue = Some(topology_issue);
    self
  }

  pub fn topology_issue(&self) -> Option<&String> {
    self.topology_issue.as_ref()
  }

  pub fn reset_topology_issue(&mut self) {
    self.topology_issue = None;
  }
