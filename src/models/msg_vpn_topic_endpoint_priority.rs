...
pub struct MsgVpnTopicEndpointPriority {
...
impl MsgVpnTopicEndpointPriority {
  pub fn new() -> MsgVpnTopicEndpointPriority {
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnTopicEndpointPriority {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_priority(mut self, priority: i64) -> MsgVpnTopicEndpointPriority {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_spooled_byte_count(mut self, spooled_byte_count: i64) -> MsgVpnTopicEndpointPriority {
    self.spooled_byte_count = Some(spooled_byte_count);
    self
  }
  ...
  pub fn with_spooled_msg_count(mut self, spooled_msg_count: i64) -> MsgVpnTopicEndpointPriority {
    self.spooled_msg_count = Some(spooled_msg_count);
    self
  }
  ...
  pub fn with_topic_endpoint_name(mut self, topic_endpoint_name: String) -> MsgVpnTopicEndpointPriority {
    self.topic_endpoint_name = Some(topic_endpoint_name);
    self
  }
