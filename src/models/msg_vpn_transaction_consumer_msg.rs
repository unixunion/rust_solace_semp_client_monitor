...
pub struct MsgVpnTransactionConsumerMsg {
...
impl MsgVpnTransactionConsumerMsg {
  pub fn new() -> MsgVpnTransactionConsumerMsg {
  ...
  pub fn with_endpoint_name(mut self, endpoint_name: String) -> MsgVpnTransactionConsumerMsg {
    self.endpoint_name = Some(endpoint_name);
    self
  }
  ...
  pub fn reset_endpoint_name(&mut self) {
    self.endpoint_name = None;
  }

  pub fn set_endpoint_type(&mut self, endpoint_type: String) {
    self.endpoint_type = Some(endpoint_type);
  }

  pub fn with_endpoint_type(mut self, endpoint_type: String) -> MsgVpnTransactionConsumerMsg {
    self.endpoint_type = Some(endpoint_type);
    self
  }

  pub fn endpoint_type(&self) -> Option<&String> {
    self.endpoint_type.as_ref()
  }

  pub fn reset_endpoint_type(&mut self) {
  ...
  pub fn with_msg_id(mut self, msg_id: i64) -> MsgVpnTransactionConsumerMsg {
    self.msg_id = Some(msg_id);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnTransactionConsumerMsg {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_xid(mut self, xid: String) -> MsgVpnTransactionConsumerMsg {
    self.xid = Some(xid);
    self
  }
