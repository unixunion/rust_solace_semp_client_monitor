...
pub struct MsgVpnTransactionPublisherMsg {
...
impl MsgVpnTransactionPublisherMsg {
  pub fn new() -> MsgVpnTransactionPublisherMsg {
  ...
  pub fn with_msg_id(mut self, msg_id: i64) -> MsgVpnTransactionPublisherMsg {
    self.msg_id = Some(msg_id);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnTransactionPublisherMsg {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_topic(mut self, topic: String) -> MsgVpnTransactionPublisherMsg {
    self.topic = Some(topic);
    self
  }
  ...
  pub fn with_xid(mut self, xid: String) -> MsgVpnTransactionPublisherMsg {
    self.xid = Some(xid);
    self
  }
