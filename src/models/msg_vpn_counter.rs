...
impl MsgVpnCounter {
  ...
  pub fn set_tls_rx_byte_count(&mut self, tls_rx_byte_count: i32) {
    self.tls_rx_byte_count = Some(tls_rx_byte_count);
  }

  pub fn with_tls_rx_byte_count(mut self, tls_rx_byte_count: i32) -> MsgVpnCounter {
    self.tls_rx_byte_count = Some(tls_rx_byte_count);
    self
  }

  pub fn tls_rx_byte_count(&self) -> Option<&i32> {
