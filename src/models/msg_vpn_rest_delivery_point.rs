...
pub struct MsgVpnRestDeliveryPoint {
  ...
  #[serde(rename = "timeConnectionsBlocked", skip_serializing_if="Option::is_none")]
  time_connections_blocked: Option<i64>,
...
impl MsgVpnRestDeliveryPoint {
  ...
  pub fn with_client_name(mut self, client_name: String) -> MsgVpnRestDeliveryPoint {
    self.client_name = Some(client_name);
    self
  }
  ...
  pub fn with_last_failure_reason(mut self, last_failure_reason: String) -> MsgVpnRestDeliveryPoint {
    self.last_failure_reason = Some(last_failure_reason);
    self
  }
  ...
  pub fn with_last_failure_time(mut self, last_failure_time: i32) -> MsgVpnRestDeliveryPoint {
    self.last_failure_time = Some(last_failure_time);
    self
  }
  ...
  pub fn set_time_connections_blocked(&mut self, time_connections_blocked: i64) {
    self.time_connections_blocked = Some(time_connections_blocked);
  }

  pub fn with_time_connections_blocked(mut self, time_connections_blocked: i64) -> MsgVpnRestDeliveryPoint {
    self.time_connections_blocked = Some(time_connections_blocked);
    self
  }

  pub fn time_connections_blocked(&self) -> Option<&i64> {
    self.time_connections_blocked.as_ref()
  }

  pub fn reset_time_connections_blocked(&mut self) {
    self.time_connections_blocked = None;
  }
  ...
  pub fn with_up(mut self, up: bool) -> MsgVpnRestDeliveryPoint {
    self.up = Some(up);
    self
  }
