...
pub struct MsgVpnClientSubscription {
...
impl MsgVpnClientSubscription {
  pub fn new() -> MsgVpnClientSubscription {
  ...
  pub fn with_client_name(mut self, client_name: String) -> MsgVpnClientSubscription {
    self.client_name = Some(client_name);
    self
  }
  ...
  pub fn with_dto_priority(mut self, dto_priority: String) -> MsgVpnClientSubscription {
    self.dto_priority = Some(dto_priority);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnClientSubscription {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_subscription_topic(mut self, subscription_topic: String) -> MsgVpnClientSubscription {
    self.subscription_topic = Some(subscription_topic);
    self
  }
