...
pub struct MsgVpnDistributedCacheClusterInstance {
  ...
  #[serde(rename = "msgCount", skip_serializing_if="Option::is_none")]
  msg_count: Option<i64>,
  /// The number of messages cached peak for the Cache Instance. Available since 2.13.
  #[serde(rename = "msgPeakCount", skip_serializing_if="Option::is_none")]
  msg_peak_count: Option<i64>,
  ...
  #[serde(rename = "requestQueueDepthCount", skip_serializing_if="Option::is_none")]
  request_queue_depth_count: Option<i64>,
  /// The received request message queue depth peak for the Cache Instance. Available since 2.13.
  #[serde(rename = "requestQueueDepthPeakCount", skip_serializing_if="Option::is_none")]
  request_queue_depth_peak_count: Option<i64>,
  ...
  #[serde(rename = "topicCount", skip_serializing_if="Option::is_none")]
  topic_count: Option<i64>,
  /// The number of topics cached peak for the Cache Instance. Available since 2.13.
  #[serde(rename = "topicPeakCount", skip_serializing_if="Option::is_none")]
  topic_peak_count: Option<i64>
}
...
impl MsgVpnDistributedCacheClusterInstance {
  pub fn new() -> MsgVpnDistributedCacheClusterInstance {
    MsgVpnDistributedCacheClusterInstance {
      ...
      msgs_lost: None,
      rate: None,
      request_queue_depth_count: None,
      request_queue_depth_peak_count: None,
      request_rx_peak_rate: None,
      request_rx_rate: None,
      state: None,
      stop_on_lost_msg_enabled: None,
      topic_count: None,
      topic_peak_count: None
    }
  }
  ...
  pub fn with_average_data_rx_byte_peak_rate(mut self, average_data_rx_byte_peak_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.average_data_rx_byte_peak_rate = Some(average_data_rx_byte_peak_rate);
    self
  }
  ...
  pub fn with_average_data_rx_byte_rate(mut self, average_data_rx_byte_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.average_data_rx_byte_rate = Some(average_data_rx_byte_rate);
    self
  }
  ...
  pub fn with_average_data_rx_msg_peak_rate(mut self, average_data_rx_msg_peak_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.average_data_rx_msg_peak_rate = Some(average_data_rx_msg_peak_rate);
    self
  }
  ...
  pub fn with_average_data_rx_msg_rate(mut self, average_data_rx_msg_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.average_data_rx_msg_rate = Some(average_data_rx_msg_rate);
    self
  }
  ...
  pub fn with_average_data_tx_msg_peak_rate(mut self, average_data_tx_msg_peak_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.average_data_tx_msg_peak_rate = Some(average_data_tx_msg_peak_rate);
    self
  }
  ...
  pub fn with_average_data_tx_msg_rate(mut self, average_data_tx_msg_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.average_data_tx_msg_rate = Some(average_data_tx_msg_rate);
    self
  }
  ...
  pub fn with_average_request_rx_peak_rate(mut self, average_request_rx_peak_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.average_request_rx_peak_rate = Some(average_request_rx_peak_rate);
    self
  }
  ...
  pub fn with_average_request_rx_rate(mut self, average_request_rx_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.average_request_rx_rate = Some(average_request_rx_rate);
    self
  }
  ...
  pub fn with_data_rx_byte_peak_rate(mut self, data_rx_byte_peak_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.data_rx_byte_peak_rate = Some(data_rx_byte_peak_rate);
    self
  }
  ...
  pub fn with_data_rx_byte_rate(mut self, data_rx_byte_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.data_rx_byte_rate = Some(data_rx_byte_rate);
    self
  }
  ...
  pub fn with_data_rx_msg_peak_rate(mut self, data_rx_msg_peak_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.data_rx_msg_peak_rate = Some(data_rx_msg_peak_rate);
    self
  }
  ...
  pub fn with_data_rx_msg_rate(mut self, data_rx_msg_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.data_rx_msg_rate = Some(data_rx_msg_rate);
    self
  }
  ...
  pub fn with_data_tx_msg_peak_rate(mut self, data_tx_msg_peak_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.data_tx_msg_peak_rate = Some(data_tx_msg_peak_rate);
    self
  }
  ...
  pub fn with_data_tx_msg_rate(mut self, data_tx_msg_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.data_tx_msg_rate = Some(data_tx_msg_rate);
    self
  }
  ...
  pub fn set_msg_count(&mut self, msg_count: i64) {
    self.msg_count = Some(msg_count);
  }

  pub fn with_msg_count(mut self, msg_count: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.msg_count = Some(msg_count);
    self
  }

  pub fn msg_count(&self) -> Option<&i64> {
    self.msg_count.as_ref()
  }

  pub fn reset_msg_count(&mut self) {
    self.msg_count = None;
  }

  pub fn set_msg_peak_count(&mut self, msg_peak_count: i64) {
    self.msg_peak_count = Some(msg_peak_count);
  }

  pub fn with_msg_peak_count(mut self, msg_peak_count: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.msg_peak_count = Some(msg_peak_count);
    self
  }

  pub fn msg_peak_count(&self) -> Option<&i64> {
    self.msg_peak_count.as_ref()
  }

  pub fn reset_msg_peak_count(&mut self) {
    self.msg_peak_count = None;
  }
  ...
  pub fn set_request_queue_depth_count(&mut self, request_queue_depth_count: i64) {
    self.request_queue_depth_count = Some(request_queue_depth_count);
  }

  pub fn with_request_queue_depth_count(mut self, request_queue_depth_count: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.request_queue_depth_count = Some(request_queue_depth_count);
    self
  }

  pub fn request_queue_depth_count(&self) -> Option<&i64> {
    self.request_queue_depth_count.as_ref()
  }

  pub fn reset_request_queue_depth_count(&mut self) {
    self.request_queue_depth_count = None;
  }

  pub fn set_request_queue_depth_peak_count(&mut self, request_queue_depth_peak_count: i64) {
    self.request_queue_depth_peak_count = Some(request_queue_depth_peak_count);
  }

  pub fn with_request_queue_depth_peak_count(mut self, request_queue_depth_peak_count: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.request_queue_depth_peak_count = Some(request_queue_depth_peak_count);
    self
  }

  pub fn request_queue_depth_peak_count(&self) -> Option<&i64> {
    self.request_queue_depth_peak_count.as_ref()
  }

  pub fn reset_request_queue_depth_peak_count(&mut self) {
    self.request_queue_depth_peak_count = None;
  }
  ...
  pub fn with_request_rx_peak_rate(mut self, request_rx_peak_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.request_rx_peak_rate = Some(request_rx_peak_rate);
    self
  }
  ...
  pub fn with_request_rx_rate(mut self, request_rx_rate: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.request_rx_rate = Some(request_rx_rate);
    self
  }
  ...
  pub fn set_topic_count(&mut self, topic_count: i64) {
    self.topic_count = Some(topic_count);
  }

  pub fn with_topic_count(mut self, topic_count: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.topic_count = Some(topic_count);
    self
  }

  pub fn topic_count(&self) -> Option<&i64> {
    self.topic_count.as_ref()
  }

  pub fn reset_topic_count(&mut self) {
    self.topic_count = None;
  }

  pub fn set_topic_peak_count(&mut self, topic_peak_count: i64) {
    self.topic_peak_count = Some(topic_peak_count);
  }

  pub fn with_topic_peak_count(mut self, topic_peak_count: i64) -> MsgVpnDistributedCacheClusterInstance {
    self.topic_peak_count = Some(topic_peak_count);
    self
  }

  pub fn topic_peak_count(&self) -> Option<&i64> {
    self.topic_peak_count.as_ref()
  }

  pub fn reset_topic_peak_count(&mut self) {
    self.topic_peak_count = None;
  }
