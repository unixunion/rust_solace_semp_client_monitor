...
/// MsgVpnMqttSessionCounter : The counters for the MQTT Session. Deprecated since 2.16. All attributes in this object have been moved to the MsgVpnMqttSession object.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct MsgVpnMqttSessionCounter {
  /// The number of MQTT connect acknowledgment (CONNACK) refused response packets transmitted to the Client. Deprecated since 2.16. This attribute has been moved to the MsgVpnMqttSession object.
  #[serde(rename = "mqttConnackErrorTxCount", skip_serializing_if="Option::is_none")]
  mqtt_connack_error_tx_count: Option<i64>,
  /// The number of MQTT connect acknowledgment (CONNACK) accepted response packets transmitted to the Client. Deprecated since 2.16. This attribute has been moved to the MsgVpnMqttSession object.
  #[serde(rename = "mqttConnackTxCount", skip_serializing_if="Option::is_none")]
  mqtt_connack_tx_count: Option<i64>,
  /// The number of MQTT connect (CONNECT) request packets received from the Client. Deprecated since 2.16. This attribute has been moved to the MsgVpnMqttSession object.
  #[serde(rename = "mqttConnectRxCount", skip_serializing_if="Option::is_none")]
  mqtt_connect_rx_count: Option<i32>,
  /// The number of MQTT disconnect (DISCONNECT) request packets received from the Client. Deprecated since 2.16. This attribute has been moved to the MsgVpnMqttSession object.
  #[serde(rename = "mqttDisconnectRxCount", skip_serializing_if="Option::is_none")]
  mqtt_disconnect_rx_count: Option<i64>,
  /// The number of MQTT publish complete (PUBCOMP) packets transmitted to the Client in response to a PUBREL packet. These packets are the fourth and final packet of a QoS 2 protocol exchange. Deprecated since 2.16. This attribute has been moved to the MsgVpnMqttSession object.
  #[serde(rename = "mqttPubcompTxCount", skip_serializing_if="Option::is_none")]
  mqtt_pubcomp_tx_count: Option<i64>,
  /// The number of MQTT publish message (PUBLISH) request packets received from the Client for QoS 0 message delivery. Deprecated since 2.16. This attribute has been moved to the MsgVpnMqttSession object.
  #[serde(rename = "mqttPublishQos0RxCount", skip_serializing_if="Option::is_none")]
  mqtt_publish_qos0_rx_count: Option<i64>,
  /// The number of MQTT publish message (PUBLISH) request packets transmitted to the Client for QoS 0 message delivery. Deprecated since 2.16. This attribute has been moved to the MsgVpnMqttSession object.
  #[serde(rename = "mqttPublishQos0TxCount", skip_serializing_if="Option::is_none")]
  mqtt_publish_qos0_tx_count: Option<i64>,
  /// The number of MQTT publish message (PUBLISH) request packets received from the Client for QoS 1 message delivery. Deprecated since 2.16. This attribute has been moved to the MsgVpnMqttSession object.
  #[serde(rename = "mqttPublishQos1RxCount", skip_serializing_if="Option::is_none")]
  mqtt_publish_qos1_rx_count: Option<i64>,
  /// The number of MQTT publish message (PUBLISH) request packets transmitted to the Client for QoS 1 message delivery. Deprecated since 2.16. This attribute has been moved to the MsgVpnMqttSession object.
  #[serde(rename = "mqttPublishQos1TxCount", skip_serializing_if="Option::is_none")]
  mqtt_publish_qos1_tx_count: Option<i64>,
  /// The number of MQTT publish message (PUBLISH) request packets received from the Client for QoS 2 message delivery. Deprecated since 2.16. This attribute has been moved to the MsgVpnMqttSession object.
  #[serde(rename = "mqttPublishQos2RxCount", skip_serializing_if="Option::is_none")]
  mqtt_publish_qos2_rx_count: Option<i64>,
  /// The number of MQTT publish received (PUBREC) packets transmitted to the Client in response to a PUBLISH packet with QoS 2. These packets are the second packet of a QoS 2 protocol exchange. Deprecated since 2.16. This attribute has been moved to the MsgVpnMqttSession object.
  #[serde(rename = "mqttPubrecTxCount", skip_serializing_if="Option::is_none")]
  mqtt_pubrec_tx_count: Option<i64>,
  /// The number of MQTT publish release (PUBREL) packets received from the Client in response to a PUBREC packet. These packets are the third packet of a QoS 2 protocol exchange. Deprecated since 2.16. This attribute has been moved to the MsgVpnMqttSession object.
  #[serde(rename = "mqttPubrelRxCount", skip_serializing_if="Option::is_none")]
  mqtt_pubrel_rx_count: Option<i64>
}

impl MsgVpnMqttSessionCounter {
  /// The counters for the MQTT Session. Deprecated since 2.16. All attributes in this object have been moved to the MsgVpnMqttSession object.
  pub fn new() -> MsgVpnMqttSessionCounter {
  ...
  pub fn with_mqtt_connack_error_tx_count(mut self, mqtt_connack_error_tx_count: i64) -> MsgVpnMqttSessionCounter {
    self.mqtt_connack_error_tx_count = Some(mqtt_connack_error_tx_count);
    self
  }
  ...
  pub fn with_mqtt_connack_tx_count(mut self, mqtt_connack_tx_count: i64) -> MsgVpnMqttSessionCounter {
    self.mqtt_connack_tx_count = Some(mqtt_connack_tx_count);
    self
  }
  ...
  pub fn with_mqtt_connect_rx_count(mut self, mqtt_connect_rx_count: i32) -> MsgVpnMqttSessionCounter {
    self.mqtt_connect_rx_count = Some(mqtt_connect_rx_count);
    self
  }
  ...
  pub fn with_mqtt_disconnect_rx_count(mut self, mqtt_disconnect_rx_count: i64) -> MsgVpnMqttSessionCounter {
    self.mqtt_disconnect_rx_count = Some(mqtt_disconnect_rx_count);
    self
  }
  ...
  pub fn with_mqtt_pubcomp_tx_count(mut self, mqtt_pubcomp_tx_count: i64) -> MsgVpnMqttSessionCounter {
    self.mqtt_pubcomp_tx_count = Some(mqtt_pubcomp_tx_count);
    self
  }
  ...
  pub fn with_mqtt_publish_qos0_rx_count(mut self, mqtt_publish_qos0_rx_count: i64) -> MsgVpnMqttSessionCounter {
    self.mqtt_publish_qos0_rx_count = Some(mqtt_publish_qos0_rx_count);
    self
  }
  ...
  pub fn with_mqtt_publish_qos0_tx_count(mut self, mqtt_publish_qos0_tx_count: i64) -> MsgVpnMqttSessionCounter {
    self.mqtt_publish_qos0_tx_count = Some(mqtt_publish_qos0_tx_count);
    self
  }
  ...
  pub fn with_mqtt_publish_qos1_rx_count(mut self, mqtt_publish_qos1_rx_count: i64) -> MsgVpnMqttSessionCounter {
    self.mqtt_publish_qos1_rx_count = Some(mqtt_publish_qos1_rx_count);
    self
  }
  ...
  pub fn with_mqtt_publish_qos1_tx_count(mut self, mqtt_publish_qos1_tx_count: i64) -> MsgVpnMqttSessionCounter {
    self.mqtt_publish_qos1_tx_count = Some(mqtt_publish_qos1_tx_count);
    self
  }
  ...
  pub fn with_mqtt_publish_qos2_rx_count(mut self, mqtt_publish_qos2_rx_count: i64) -> MsgVpnMqttSessionCounter {
    self.mqtt_publish_qos2_rx_count = Some(mqtt_publish_qos2_rx_count);
    self
  }
  ...
  pub fn with_mqtt_pubrec_tx_count(mut self, mqtt_pubrec_tx_count: i64) -> MsgVpnMqttSessionCounter {
    self.mqtt_pubrec_tx_count = Some(mqtt_pubrec_tx_count);
    self
  }
  ...
  pub fn with_mqtt_pubrel_rx_count(mut self, mqtt_pubrel_rx_count: i64) -> MsgVpnMqttSessionCounter {
    self.mqtt_pubrel_rx_count = Some(mqtt_pubrel_rx_count);
    self
  }
