...
pub struct MsgVpnQueueTxFlow {
  ...
  #[serde(rename = "activityUpdateState", skip_serializing_if="Option::is_none")]
  activity_update_state: Option<String>,
...
impl MsgVpnQueueTxFlow {
  pub fn new() -> MsgVpnQueueTxFlow {
    MsgVpnQueueTxFlow {
      acked_msg_count: None,
      activation_time: None,
      activity_state: None,
      activity_update_state: None,
      bind_time: None,
      client_name: None,
  ...
  pub fn with_acked_msg_count(mut self, acked_msg_count: i64) -> MsgVpnQueueTxFlow {
    self.acked_msg_count = Some(acked_msg_count);
    self
  }
  ...
  pub fn set_activation_time(&mut self, activation_time: i32) {
    self.activation_time = Some(activation_time);
  }

  pub fn with_activation_time(mut self, activation_time: i32) -> MsgVpnQueueTxFlow {
    self.activation_time = Some(activation_time);
    self
  }

  pub fn activation_time(&self) -> Option<&i32> {
    self.activation_time.as_ref()
  }

  pub fn reset_activation_time(&mut self) {
  ...
  pub fn with_activity_state(mut self, activity_state: String) -> MsgVpnQueueTxFlow {
    self.activity_state = Some(activity_state);
    self
  }
  ...
  pub fn set_activity_update_state(&mut self, activity_update_state: String) {
    self.activity_update_state = Some(activity_update_state);
  }

  pub fn with_activity_update_state(mut self, activity_update_state: String) -> MsgVpnQueueTxFlow {
    self.activity_update_state = Some(activity_update_state);
    self
  }

  pub fn activity_update_state(&self) -> Option<&String> {
    self.activity_update_state.as_ref()
  }

  pub fn reset_activity_update_state(&mut self) {
    self.activity_update_state = None;
  }
  ...
  pub fn with_bind_time(mut self, bind_time: i32) -> MsgVpnQueueTxFlow {
    self.bind_time = Some(bind_time);
    self
  }
  ...
  pub fn with_client_name(mut self, client_name: String) -> MsgVpnQueueTxFlow {
    self.client_name = Some(client_name);
    self
  }
  ...
  pub fn with_consumer_redelivery_request_allowed(mut self, consumer_redelivery_request_allowed: bool) -> MsgVpnQueueTxFlow {
    self.consumer_redelivery_request_allowed = Some(consumer_redelivery_request_allowed);
    self
  }
  ...
  pub fn with_cut_through_acked_msg_count(mut self, cut_through_acked_msg_count: i64) -> MsgVpnQueueTxFlow {
    self.cut_through_acked_msg_count = Some(cut_through_acked_msg_count);
    self
  }
  ...
  pub fn with_delivery_state(mut self, delivery_state: String) -> MsgVpnQueueTxFlow {
    self.delivery_state = Some(delivery_state);
    self
  }
  ...
  pub fn with_flow_id(mut self, flow_id: i64) -> MsgVpnQueueTxFlow {
    self.flow_id = Some(flow_id);
    self
  }
  ...
  pub fn with_highest_ack_pending_msg_id(mut self, highest_ack_pending_msg_id: i64) -> MsgVpnQueueTxFlow {
    self.highest_ack_pending_msg_id = Some(highest_ack_pending_msg_id);
    self
  }
  ...
  pub fn with_last_acked_msg_id(mut self, last_acked_msg_id: i64) -> MsgVpnQueueTxFlow {
    self.last_acked_msg_id = Some(last_acked_msg_id);
    self
  }
  ...
  pub fn with_last_selector_examined_msg_id(mut self, last_selector_examined_msg_id: i64) -> MsgVpnQueueTxFlow {
    self.last_selector_examined_msg_id = Some(last_selector_examined_msg_id);
    self
  }
  ...
  pub fn with_lowest_ack_pending_msg_id(mut self, lowest_ack_pending_msg_id: i64) -> MsgVpnQueueTxFlow {
    self.lowest_ack_pending_msg_id = Some(lowest_ack_pending_msg_id);
    self
  }
  ...
  pub fn with_max_unacked_msgs_exceeded_msg_count(mut self, max_unacked_msgs_exceeded_msg_count: i64) -> MsgVpnQueueTxFlow {
    self.max_unacked_msgs_exceeded_msg_count = Some(max_unacked_msgs_exceeded_msg_count);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnQueueTxFlow {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_no_local_delivery(mut self, no_local_delivery: bool) -> MsgVpnQueueTxFlow {
    self.no_local_delivery = Some(no_local_delivery);
    self
  }
  ...
  pub fn with_queue_name(mut self, queue_name: String) -> MsgVpnQueueTxFlow {
    self.queue_name = Some(queue_name);
    self
  }
  ...
  pub fn with_redelivered_msg_count(mut self, redelivered_msg_count: i64) -> MsgVpnQueueTxFlow {
    self.redelivered_msg_count = Some(redelivered_msg_count);
    self
  }
  ...
  pub fn with_redelivery_request_count(mut self, redelivery_request_count: i64) -> MsgVpnQueueTxFlow {
    self.redelivery_request_count = Some(redelivery_request_count);
    self
  }
  ...
  pub fn with_selector(mut self, selector: String) -> MsgVpnQueueTxFlow {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_selector_examined_msg_count(mut self, selector_examined_msg_count: i64) -> MsgVpnQueueTxFlow {
    self.selector_examined_msg_count = Some(selector_examined_msg_count);
    self
  }
  ...
  pub fn with_selector_matched_msg_count(mut self, selector_matched_msg_count: i64) -> MsgVpnQueueTxFlow {
    self.selector_matched_msg_count = Some(selector_matched_msg_count);
    self
  }
  ...
  pub fn with_selector_not_matched_msg_count(mut self, selector_not_matched_msg_count: i64) -> MsgVpnQueueTxFlow {
    self.selector_not_matched_msg_count = Some(selector_not_matched_msg_count);
    self
  }
  ...
  pub fn with_session_name(mut self, session_name: String) -> MsgVpnQueueTxFlow {
    self.session_name = Some(session_name);
    self
  }
  ...
  pub fn with_store_and_forward_acked_msg_count(mut self, store_and_forward_acked_msg_count: i64) -> MsgVpnQueueTxFlow {
    self.store_and_forward_acked_msg_count = Some(store_and_forward_acked_msg_count);
    self
  }
  ...
  pub fn with_unacked_msg_count(mut self, unacked_msg_count: i64) -> MsgVpnQueueTxFlow {
    self.unacked_msg_count = Some(unacked_msg_count);
    self
  }
  ...
  pub fn with_used_window_size(mut self, used_window_size: i32) -> MsgVpnQueueTxFlow {
    self.used_window_size = Some(used_window_size);
    self
  }
  ...
  pub fn with_window_closed_count(mut self, window_closed_count: i64) -> MsgVpnQueueTxFlow {
    self.window_closed_count = Some(window_closed_count);
    self
  }
  ...
  pub fn with_window_size(mut self, window_size: i64) -> MsgVpnQueueTxFlow {
    self.window_size = Some(window_size);
    self
  }
