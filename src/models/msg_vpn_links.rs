...
pub struct MsgVpnLinks {
  ...
  #[serde(rename = "configSyncRemoteNodesUri", skip_serializing_if="Option::is_none")]
  config_sync_remote_nodes_uri: Option<String>,
  ...
  #[serde(rename = "transactionsUri", skip_serializing_if="Option::is_none")]
  transactions_uri: Option<String>,
...
impl MsgVpnLinks {
  pub fn new() -> MsgVpnLinks {
    MsgVpnLinks {
      ...
      clients_uri: None,
      config_sync_remote_nodes_uri: None,
  ...
  pub fn set_config_sync_remote_nodes_uri(&mut self, config_sync_remote_nodes_uri: String) {
    self.config_sync_remote_nodes_uri = Some(config_sync_remote_nodes_uri);
  }

  pub fn with_config_sync_remote_nodes_uri(mut self, config_sync_remote_nodes_uri: String) -> MsgVpnLinks {
    self.config_sync_remote_nodes_uri = Some(config_sync_remote_nodes_uri);
    self
  }

  pub fn config_sync_remote_nodes_uri(&self) -> Option<&String> {
    self.config_sync_remote_nodes_uri.as_ref()
  }

  pub fn reset_config_sync_remote_nodes_uri(&mut self) {
    self.config_sync_remote_nodes_uri = None;
  }
  ...
  pub fn set_transactions_uri(&mut self, transactions_uri: String) {
    self.transactions_uri = Some(transactions_uri);
  }

  pub fn with_transactions_uri(mut self, transactions_uri: String) -> MsgVpnLinks {
    self.transactions_uri = Some(transactions_uri);
    self
  }

  pub fn transactions_uri(&self) -> Option<&String> {
    self.transactions_uri.as_ref()
  }

  pub fn reset_transactions_uri(&mut self) {
    self.transactions_uri = None;
  }
