...
pub struct DmrClusterLink {
  ...
  /// The message discard behavior, providing the condition for returning a negative acknowledgement (NACK) to the sender. The allowed values and their meaning are:  <pre> \"always\" - Always return a negative acknowledgment (NACK) to the sending client on message discard. \"when-queue-enabled\" - Only return a negative acknowledgment (NACK) to the sending client on message discard when the Queue is enabled. \"never\" - Never return a negative acknowledgment (NACK) to the sending client on message discard. </pre> 
  ...
  /// Enable or disable encryption on the Link.
...
impl DmrClusterLink {
  ...
  pub fn with_client_profile_name(mut self, client_profile_name: String) -> DmrClusterLink {
    self.client_profile_name = Some(client_profile_name);
    self
  }
  ...
  pub fn with_failure_reason(mut self, failure_reason: String) -> DmrClusterLink {
    self.failure_reason = Some(failure_reason);
    self
  }
  ...
  pub fn with_up(mut self, up: bool) -> DmrClusterLink {
    self.up = Some(up);
    self
  }
  ...
  pub fn with_uptime(mut self, uptime: i64) -> DmrClusterLink {
    self.uptime = Some(uptime);
    self
  }
