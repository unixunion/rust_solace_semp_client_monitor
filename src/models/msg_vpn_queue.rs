...
pub struct MsgVpnQueue {
  ...
  /// Indicates whether the respecting of message priority is enabled. When enabled, messages contained in the Queue are delivered in priority order, from 9 (highest) to 0 (lowest).
  ...
  #[serde(rename = "txSelector", skip_serializing_if="Option::is_none")]
  tx_selector: Option<bool>,
...
impl MsgVpnQueue {
  ...
  pub fn with_already_bound_bind_failure_count(mut self, already_bound_bind_failure_count: i64) -> MsgVpnQueue {
    self.already_bound_bind_failure_count = Some(already_bound_bind_failure_count);
    self
  }
  ...
  pub fn with_average_rx_byte_rate(mut self, average_rx_byte_rate: i64) -> MsgVpnQueue {
    self.average_rx_byte_rate = Some(average_rx_byte_rate);
    self
  }
  ...
  pub fn with_average_rx_msg_rate(mut self, average_rx_msg_rate: i64) -> MsgVpnQueue {
    self.average_rx_msg_rate = Some(average_rx_msg_rate);
    self
  }
  ...
  pub fn with_average_tx_byte_rate(mut self, average_tx_byte_rate: i64) -> MsgVpnQueue {
    self.average_tx_byte_rate = Some(average_tx_byte_rate);
    self
  }
  ...
  pub fn with_average_tx_msg_rate(mut self, average_tx_msg_rate: i64) -> MsgVpnQueue {
    self.average_tx_msg_rate = Some(average_tx_msg_rate);
    self
  }
  ...
  pub fn with_bind_request_count(mut self, bind_request_count: i64) -> MsgVpnQueue {
    self.bind_request_count = Some(bind_request_count);
    self
  }
  ...
  pub fn with_bind_success_count(mut self, bind_success_count: i64) -> MsgVpnQueue {
    self.bind_success_count = Some(bind_success_count);
    self
  }
  ...
  pub fn with_bind_time_forwarding_mode(mut self, bind_time_forwarding_mode: String) -> MsgVpnQueue {
    self.bind_time_forwarding_mode = Some(bind_time_forwarding_mode);
    self
  }
  ...
  pub fn with_client_profile_denied_discarded_msg_count(mut self, client_profile_denied_discarded_msg_count: i64) -> MsgVpnQueue {
    self.client_profile_denied_discarded_msg_count = Some(client_profile_denied_discarded_msg_count);
    self
  }
  ...
  pub fn with_created_by_management(mut self, created_by_management: bool) -> MsgVpnQueue {
    self.created_by_management = Some(created_by_management);
    self
  }
  ...
  pub fn with_deleted_msg_count(mut self, deleted_msg_count: i64) -> MsgVpnQueue {
    self.deleted_msg_count = Some(deleted_msg_count);
    self
  }
  ...
  pub fn with_destination_group_error_discarded_msg_count(mut self, destination_group_error_discarded_msg_count: i64) -> MsgVpnQueue {
    self.destination_group_error_discarded_msg_count = Some(destination_group_error_discarded_msg_count);
    self
  }
  ...
  pub fn with_disabled_bind_failure_count(mut self, disabled_bind_failure_count: i64) -> MsgVpnQueue {
    self.disabled_bind_failure_count = Some(disabled_bind_failure_count);
    self
  }
  ...
  pub fn with_disabled_discarded_msg_count(mut self, disabled_discarded_msg_count: i64) -> MsgVpnQueue {
    self.disabled_discarded_msg_count = Some(disabled_discarded_msg_count);
    self
  }
  ...
  pub fn with_durable(mut self, durable: bool) -> MsgVpnQueue {
    self.durable = Some(durable);
    self
  }
  ...
  pub fn with_highest_acked_msg_id(mut self, highest_acked_msg_id: i64) -> MsgVpnQueue {
    self.highest_acked_msg_id = Some(highest_acked_msg_id);
    self
  }
  ...
  pub fn with_highest_msg_id(mut self, highest_msg_id: i64) -> MsgVpnQueue {
    self.highest_msg_id = Some(highest_msg_id);
    self
  }
  ...
  pub fn with_in_progress_ack_msg_count(mut self, in_progress_ack_msg_count: i64) -> MsgVpnQueue {
    self.in_progress_ack_msg_count = Some(in_progress_ack_msg_count);
    self
  }
  ...
  pub fn with_invalid_selector_bind_failure_count(mut self, invalid_selector_bind_failure_count: i64) -> MsgVpnQueue {
    self.invalid_selector_bind_failure_count = Some(invalid_selector_bind_failure_count);
    self
  }
  ...
  pub fn with_last_replay_complete_time(mut self, last_replay_complete_time: i32) -> MsgVpnQueue {
    self.last_replay_complete_time = Some(last_replay_complete_time);
    self
  }
  ...
  pub fn with_last_replay_failure_reason(mut self, last_replay_failure_reason: String) -> MsgVpnQueue {
    self.last_replay_failure_reason = Some(last_replay_failure_reason);
    self
  }
  ...
  pub fn with_last_replay_failure_time(mut self, last_replay_failure_time: i32) -> MsgVpnQueue {
    self.last_replay_failure_time = Some(last_replay_failure_time);
    self
  }
  ...
  pub fn with_last_replay_start_time(mut self, last_replay_start_time: i32) -> MsgVpnQueue {
    self.last_replay_start_time = Some(last_replay_start_time);
    self
  }
  ...
  pub fn with_last_replayed_msg_tx_time(mut self, last_replayed_msg_tx_time: i32) -> MsgVpnQueue {
    self.last_replayed_msg_tx_time = Some(last_replayed_msg_tx_time);
    self
  }
  ...
  pub fn with_last_spooled_msg_id(mut self, last_spooled_msg_id: i64) -> MsgVpnQueue {
    self.last_spooled_msg_id = Some(last_spooled_msg_id);
    self
  }
  ...
  pub fn with_low_priority_msg_congestion_discarded_msg_count(mut self, low_priority_msg_congestion_discarded_msg_count: i64) -> MsgVpnQueue {
    self.low_priority_msg_congestion_discarded_msg_count = Some(low_priority_msg_congestion_discarded_msg_count);
    self
  }
  ...
  pub fn with_low_priority_msg_congestion_state(mut self, low_priority_msg_congestion_state: String) -> MsgVpnQueue {
    self.low_priority_msg_congestion_state = Some(low_priority_msg_congestion_state);
    self
  }
  ...
  pub fn with_lowest_acked_msg_id(mut self, lowest_acked_msg_id: i64) -> MsgVpnQueue {
    self.lowest_acked_msg_id = Some(lowest_acked_msg_id);
    self
  }
  ...
  pub fn with_lowest_msg_id(mut self, lowest_msg_id: i64) -> MsgVpnQueue {
    self.lowest_msg_id = Some(lowest_msg_id);
    self
  }
  ...
  pub fn with_max_bind_count_exceeded_bind_failure_count(mut self, max_bind_count_exceeded_bind_failure_count: i64) -> MsgVpnQueue {
    self.max_bind_count_exceeded_bind_failure_count = Some(max_bind_count_exceeded_bind_failure_count);
    self
  }
  ...
  pub fn with_max_msg_size_exceeded_discarded_msg_count(mut self, max_msg_size_exceeded_discarded_msg_count: i64) -> MsgVpnQueue {
    self.max_msg_size_exceeded_discarded_msg_count = Some(max_msg_size_exceeded_discarded_msg_count);
    self
  }
  ...
  pub fn with_max_msg_spool_usage_exceeded_discarded_msg_count(mut self, max_msg_spool_usage_exceeded_discarded_msg_count: i64) -> MsgVpnQueue {
    self.max_msg_spool_usage_exceeded_discarded_msg_count = Some(max_msg_spool_usage_exceeded_discarded_msg_count);
    self
  }
  ...
  pub fn with_max_redelivery_exceeded_discarded_msg_count(mut self, max_redelivery_exceeded_discarded_msg_count: i64) -> MsgVpnQueue {
    self.max_redelivery_exceeded_discarded_msg_count = Some(max_redelivery_exceeded_discarded_msg_count);
    self
  }
  ...
  pub fn with_max_redelivery_exceeded_to_dmq_failed_msg_count(mut self, max_redelivery_exceeded_to_dmq_failed_msg_count: i64) -> MsgVpnQueue {
    self.max_redelivery_exceeded_to_dmq_failed_msg_count = Some(max_redelivery_exceeded_to_dmq_failed_msg_count);
    self
  }
  ...
  pub fn with_max_redelivery_exceeded_to_dmq_msg_count(mut self, max_redelivery_exceeded_to_dmq_msg_count: i64) -> MsgVpnQueue {
    self.max_redelivery_exceeded_to_dmq_msg_count = Some(max_redelivery_exceeded_to_dmq_msg_count);
    self
  }
  ...
  pub fn with_max_ttl_exceeded_discarded_msg_count(mut self, max_ttl_exceeded_discarded_msg_count: i64) -> MsgVpnQueue {
    self.max_ttl_exceeded_discarded_msg_count = Some(max_ttl_exceeded_discarded_msg_count);
    self
  }
  ...
  pub fn with_max_ttl_expired_discarded_msg_count(mut self, max_ttl_expired_discarded_msg_count: i64) -> MsgVpnQueue {
    self.max_ttl_expired_discarded_msg_count = Some(max_ttl_expired_discarded_msg_count);
    self
  }
  ...
  pub fn with_max_ttl_expired_to_dmq_failed_msg_count(mut self, max_ttl_expired_to_dmq_failed_msg_count: i64) -> MsgVpnQueue {
    self.max_ttl_expired_to_dmq_failed_msg_count = Some(max_ttl_expired_to_dmq_failed_msg_count);
    self
  }
  ...
  pub fn with_max_ttl_expired_to_dmq_msg_count(mut self, max_ttl_expired_to_dmq_msg_count: i64) -> MsgVpnQueue {
    self.max_ttl_expired_to_dmq_msg_count = Some(max_ttl_expired_to_dmq_msg_count);
    self
  }
  ...
  pub fn with_msg_spool_peak_usage(mut self, msg_spool_peak_usage: i64) -> MsgVpnQueue {
    self.msg_spool_peak_usage = Some(msg_spool_peak_usage);
    self
  }
  ...
  pub fn with_msg_spool_usage(mut self, msg_spool_usage: i64) -> MsgVpnQueue {
    self.msg_spool_usage = Some(msg_spool_usage);
    self
  }
  ...
  pub fn with_network_topic(mut self, network_topic: String) -> MsgVpnQueue {
    self.network_topic = Some(network_topic);
    self
  }
  ...
  pub fn with_no_local_delivery_discarded_msg_count(mut self, no_local_delivery_discarded_msg_count: i64) -> MsgVpnQueue {
    self.no_local_delivery_discarded_msg_count = Some(no_local_delivery_discarded_msg_count);
    self
  }
  ...
  pub fn with_other_bind_failure_count(mut self, other_bind_failure_count: i64) -> MsgVpnQueue {
    self.other_bind_failure_count = Some(other_bind_failure_count);
    self
  }
  ...
  pub fn with_redelivered_msg_count(mut self, redelivered_msg_count: i64) -> MsgVpnQueue {
    self.redelivered_msg_count = Some(redelivered_msg_count);
    self
  }
  ...
  pub fn with_replay_failure_count(mut self, replay_failure_count: i64) -> MsgVpnQueue {
    self.replay_failure_count = Some(replay_failure_count);
    self
  }
  ...
  pub fn with_replay_start_count(mut self, replay_start_count: i64) -> MsgVpnQueue {
    self.replay_start_count = Some(replay_start_count);
    self
  }
  ...
  pub fn with_replay_state(mut self, replay_state: String) -> MsgVpnQueue {
    self.replay_state = Some(replay_state);
    self
  }
  ...
  pub fn with_replay_success_count(mut self, replay_success_count: i64) -> MsgVpnQueue {
    self.replay_success_count = Some(replay_success_count);
    self
  }
  ...
  pub fn with_replayed_acked_msg_count(mut self, replayed_acked_msg_count: i64) -> MsgVpnQueue {
    self.replayed_acked_msg_count = Some(replayed_acked_msg_count);
    self
  }
  ...
  pub fn with_replayed_tx_msg_count(mut self, replayed_tx_msg_count: i64) -> MsgVpnQueue {
    self.replayed_tx_msg_count = Some(replayed_tx_msg_count);
    self
  }
  ...
  pub fn with_replication_active_ack_prop_tx_msg_count(mut self, replication_active_ack_prop_tx_msg_count: i64) -> MsgVpnQueue {
    self.replication_active_ack_prop_tx_msg_count = Some(replication_active_ack_prop_tx_msg_count);
    self
  }
  ...
  pub fn with_replication_standby_ack_prop_rx_msg_count(mut self, replication_standby_ack_prop_rx_msg_count: i64) -> MsgVpnQueue {
    self.replication_standby_ack_prop_rx_msg_count = Some(replication_standby_ack_prop_rx_msg_count);
    self
  }
  ...
  pub fn with_replication_standby_acked_by_ack_prop_msg_count(mut self, replication_standby_acked_by_ack_prop_msg_count: i64) -> MsgVpnQueue {
    self.replication_standby_acked_by_ack_prop_msg_count = Some(replication_standby_acked_by_ack_prop_msg_count);
    self
  }
  ...
  pub fn with_replication_standby_rx_msg_count(mut self, replication_standby_rx_msg_count: i64) -> MsgVpnQueue {
    self.replication_standby_rx_msg_count = Some(replication_standby_rx_msg_count);
    self
  }
  ...
  pub fn with_rx_byte_rate(mut self, rx_byte_rate: i64) -> MsgVpnQueue {
    self.rx_byte_rate = Some(rx_byte_rate);
    self
  }
  ...
  pub fn with_rx_msg_rate(mut self, rx_msg_rate: i64) -> MsgVpnQueue {
    self.rx_msg_rate = Some(rx_msg_rate);
    self
  }
  ...
  pub fn with_spooled_byte_count(mut self, spooled_byte_count: i64) -> MsgVpnQueue {
    self.spooled_byte_count = Some(spooled_byte_count);
    self
  }
  ...
  pub fn with_spooled_msg_count(mut self, spooled_msg_count: i64) -> MsgVpnQueue {
    self.spooled_msg_count = Some(spooled_msg_count);
    self
  }
  ...
  pub fn with_tx_byte_rate(mut self, tx_byte_rate: i64) -> MsgVpnQueue {
    self.tx_byte_rate = Some(tx_byte_rate);
    self
  }
  ...
  pub fn with_tx_msg_rate(mut self, tx_msg_rate: i64) -> MsgVpnQueue {
    self.tx_msg_rate = Some(tx_msg_rate);
    self
  }
  ...
  pub fn set_tx_selector(&mut self, tx_selector: bool) {
    self.tx_selector = Some(tx_selector);
  }

  pub fn with_tx_selector(mut self, tx_selector: bool) -> MsgVpnQueue {
    self.tx_selector = Some(tx_selector);
    self
  }

  pub fn tx_selector(&self) -> Option<&bool> {
    self.tx_selector.as_ref()
  }

  pub fn reset_tx_selector(&mut self) {
    self.tx_selector = None;
  }
  ...
  pub fn with_tx_unacked_msg_count(mut self, tx_unacked_msg_count: i64) -> MsgVpnQueue {
    self.tx_unacked_msg_count = Some(tx_unacked_msg_count);
    self
  }
  ...
  pub fn with_virtual_router(mut self, virtual_router: String) -> MsgVpnQueue {
    self.virtual_router = Some(virtual_router);
    self
  }
