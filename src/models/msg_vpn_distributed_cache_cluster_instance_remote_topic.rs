...
pub struct MsgVpnDistributedCacheClusterInstanceRemoteTopic {
  ...
  #[serde(rename = "globalTopic", skip_serializing_if="Option::is_none")]
  global_topic: Option<bool>,
  ...
  #[serde(rename = "suspect", skip_serializing_if="Option::is_none")]
  suspect: Option<bool>,
...
impl MsgVpnDistributedCacheClusterInstanceRemoteTopic {
  pub fn new() -> MsgVpnDistributedCacheClusterInstanceRemoteTopic {
  ...
  pub fn with_cache_name(mut self, cache_name: String) -> MsgVpnDistributedCacheClusterInstanceRemoteTopic {
    self.cache_name = Some(cache_name);
    self
  }
  ...
  pub fn with_cluster_name(mut self, cluster_name: String) -> MsgVpnDistributedCacheClusterInstanceRemoteTopic {
    self.cluster_name = Some(cluster_name);
    self
  }
  ...
  pub fn set_global_topic(&mut self, global_topic: bool) {
    self.global_topic = Some(global_topic);
  }

  pub fn with_global_topic(mut self, global_topic: bool) -> MsgVpnDistributedCacheClusterInstanceRemoteTopic {
    self.global_topic = Some(global_topic);
    self
  }

  pub fn global_topic(&self) -> Option<&bool> {
    self.global_topic.as_ref()
  }

  pub fn reset_global_topic(&mut self) {
    self.global_topic = None;
  }
  ...
  pub fn with_home_cluster_name(mut self, home_cluster_name: String) -> MsgVpnDistributedCacheClusterInstanceRemoteTopic {
    self.home_cluster_name = Some(home_cluster_name);
    self
  }
  ...
  pub fn with_instance_name(mut self, instance_name: String) -> MsgVpnDistributedCacheClusterInstanceRemoteTopic {
    self.instance_name = Some(instance_name);
    self
  }
  ...
  pub fn with_msg_count(mut self, msg_count: i32) -> MsgVpnDistributedCacheClusterInstanceRemoteTopic {
    self.msg_count = Some(msg_count);
    self
  }

  pub fn msg_count(&self) -> Option<&i32> {
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnDistributedCacheClusterInstanceRemoteTopic {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn set_suspect(&mut self, suspect: bool) {
    self.suspect = Some(suspect);
  }

  pub fn with_suspect(mut self, suspect: bool) -> MsgVpnDistributedCacheClusterInstanceRemoteTopic {
    self.suspect = Some(suspect);
    self
  }
  ...
  pub fn with_topic(mut self, topic: String) -> MsgVpnDistributedCacheClusterInstanceRemoteTopic {
    self.topic = Some(topic);
    self
  }
