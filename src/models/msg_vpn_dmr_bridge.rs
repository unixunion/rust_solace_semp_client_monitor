...
impl MsgVpnDmrBridge {
  ...
  pub fn with_failure_reason(mut self, failure_reason: String) -> MsgVpnDmrBridge {
    self.failure_reason = Some(failure_reason);
    self
  }
  ...
  pub fn with_up(mut self, up: bool) -> MsgVpnDmrBridge {
    self.up = Some(up);
    self
  }
  ...
  pub fn with_uptime(mut self, uptime: i64) -> MsgVpnDmrBridge {
    self.uptime = Some(uptime);
    self
  }
