...
pub struct MsgVpnReplayLogMsgsResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<Vec<::models::MsgVpnReplayLogMsg>>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<Vec<::models::MsgVpnReplayLogMsgLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnReplayLogMsgsResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnReplayLogMsgsResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnReplayLogMsg>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnReplayLogMsg>) -> MsgVpnReplayLogMsgsResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnReplayLogMsg>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnReplayLogMsgLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnReplayLogMsgLinks>) -> MsgVpnReplayLogMsgsResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnReplayLogMsgLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnReplayLogMsgsResponse {
    self.meta = meta;
    self
  }
