...
pub struct MsgVpnBridgeLocalSubscription {
  ...
  #[serde(rename = "dtoPriority", skip_serializing_if="Option::is_none")]
  dto_priority: Option<String>,
  /// The topic of the Bridge local subscription.
  #[serde(rename = "localSubscriptionTopic", skip_serializing_if="Option::is_none")]
  local_subscription_topic: Option<String>,
  /// The name of the Message VPN.
  #[serde(rename = "msgVpnName", skip_serializing_if="Option::is_none")]
  msg_vpn_name: Option<String>
}

impl MsgVpnBridgeLocalSubscription {
  pub fn new() -> MsgVpnBridgeLocalSubscription {
    MsgVpnBridgeLocalSubscription {
      bridge_name: None,
      bridge_virtual_router: None,
      dto_priority: None,
      local_subscription_topic: None,
      msg_vpn_name: None
    }
  }
  ...
  pub fn with_bridge_name(mut self, bridge_name: String) -> MsgVpnBridgeLocalSubscription {
    self.bridge_name = Some(bridge_name);
    self
  }
  ...
  pub fn with_bridge_virtual_router(mut self, bridge_virtual_router: String) -> MsgVpnBridgeLocalSubscription {
    self.bridge_virtual_router = Some(bridge_virtual_router);
    self
  }
  ...
  pub fn set_dto_priority(&mut self, dto_priority: String) {
    self.dto_priority = Some(dto_priority);
  }

  pub fn with_dto_priority(mut self, dto_priority: String) -> MsgVpnBridgeLocalSubscription {
    self.dto_priority = Some(dto_priority);
    self
  }

  pub fn dto_priority(&self) -> Option<&String> {
    self.dto_priority.as_ref()
  }

  pub fn reset_dto_priority(&mut self) {
    self.dto_priority = None;
  }

  pub fn set_local_subscription_topic(&mut self, local_subscription_topic: String) {
    self.local_subscription_topic = Some(local_subscription_topic);
  }

  pub fn with_local_subscription_topic(mut self, local_subscription_topic: String) -> MsgVpnBridgeLocalSubscription {
    self.local_subscription_topic = Some(local_subscription_topic);
    self
  }

  pub fn local_subscription_topic(&self) -> Option<&String> {
    self.local_subscription_topic.as_ref()
  }

  pub fn reset_local_subscription_topic(&mut self) {
    self.local_subscription_topic = None;
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnBridgeLocalSubscription {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
