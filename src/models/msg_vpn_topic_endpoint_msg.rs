...
pub struct MsgVpnTopicEndpointMsg {
...
impl MsgVpnTopicEndpointMsg {
  pub fn new() -> MsgVpnTopicEndpointMsg {
  ...
  pub fn with_attachment_size(mut self, attachment_size: i64) -> MsgVpnTopicEndpointMsg {
    self.attachment_size = Some(attachment_size);
    self
  }
  ...
  pub fn with_content_size(mut self, content_size: i64) -> MsgVpnTopicEndpointMsg {
    self.content_size = Some(content_size);
    self
  }
  ...
  pub fn with_dmq_eligible(mut self, dmq_eligible: bool) -> MsgVpnTopicEndpointMsg {
    self.dmq_eligible = Some(dmq_eligible);
    self
  }
  ...
  pub fn with_expiry_time(mut self, expiry_time: i32) -> MsgVpnTopicEndpointMsg {
    self.expiry_time = Some(expiry_time);
    self
  }
  ...
  pub fn with_msg_id(mut self, msg_id: i64) -> MsgVpnTopicEndpointMsg {
    self.msg_id = Some(msg_id);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnTopicEndpointMsg {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> MsgVpnTopicEndpointMsg {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_publisher_id(mut self, publisher_id: i64) -> MsgVpnTopicEndpointMsg {
    self.publisher_id = Some(publisher_id);
    self
  }
  ...
  pub fn with_redelivery_count(mut self, redelivery_count: i32) -> MsgVpnTopicEndpointMsg {
    self.redelivery_count = Some(redelivery_count);
    self
  }
  ...
  pub fn with_replicated_mate_msg_id(mut self, replicated_mate_msg_id: i64) -> MsgVpnTopicEndpointMsg {
    self.replicated_mate_msg_id = Some(replicated_mate_msg_id);
    self
  }
  ...
  pub fn with_replication_state(mut self, replication_state: String) -> MsgVpnTopicEndpointMsg {
    self.replication_state = Some(replication_state);
    self
  }
  ...
  pub fn with_spooled_time(mut self, spooled_time: i32) -> MsgVpnTopicEndpointMsg {
    self.spooled_time = Some(spooled_time);
    self
  }
  ...
  pub fn with_topic_endpoint_name(mut self, topic_endpoint_name: String) -> MsgVpnTopicEndpointMsg {
    self.topic_endpoint_name = Some(topic_endpoint_name);
    self
  }
  ...
  pub fn with_undelivered(mut self, undelivered: bool) -> MsgVpnTopicEndpointMsg {
    self.undelivered = Some(undelivered);
    self
  }
