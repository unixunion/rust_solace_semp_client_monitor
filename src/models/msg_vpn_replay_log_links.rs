...
pub struct MsgVpnReplayLogLinks {
  /// The URI of this MsgVpnReplayLog's msgs collection.
...
impl MsgVpnReplayLogLinks {
  pub fn new() -> MsgVpnReplayLogLinks {
  ...
  pub fn with_msgs_uri(mut self, msgs_uri: String) -> MsgVpnReplayLogLinks {
    self.msgs_uri = Some(msgs_uri);
    self
  }
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnReplayLogLinks {
    self.uri = Some(uri);
    self
  }
