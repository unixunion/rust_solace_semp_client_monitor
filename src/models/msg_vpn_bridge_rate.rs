...
/// MsgVpnBridgeRate : The rates for the Bridge. Deprecated since 2.16. All attributes in this object have been moved to the MsgVpnBridge object.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct MsgVpnBridgeRate {
  /// The one minute average of the message rate received from the Bridge, in bytes per second (B/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "averageRxByteRate", skip_serializing_if="Option::is_none")]
  average_rx_byte_rate: Option<i64>,
  /// The one minute average of the message rate received from the Bridge, in messages per second (msg/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "averageRxMsgRate", skip_serializing_if="Option::is_none")]
  average_rx_msg_rate: Option<i64>,
  /// The one minute average of the message rate transmitted to the Bridge, in bytes per second (B/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "averageTxByteRate", skip_serializing_if="Option::is_none")]
  average_tx_byte_rate: Option<i64>,
  /// The one minute average of the message rate transmitted to the Bridge, in messages per second (msg/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "averageTxMsgRate", skip_serializing_if="Option::is_none")]
  average_tx_msg_rate: Option<i64>,
  /// The current message rate received from the Bridge, in bytes per second (B/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "rxByteRate", skip_serializing_if="Option::is_none")]
  rx_byte_rate: Option<i64>,
  /// The current message rate received from the Bridge, in messages per second (msg/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "rxMsgRate", skip_serializing_if="Option::is_none")]
  rx_msg_rate: Option<i64>,
  /// The current message rate transmitted to the Bridge, in bytes per second (B/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "txByteRate", skip_serializing_if="Option::is_none")]
  tx_byte_rate: Option<i64>,
  /// The current message rate transmitted to the Bridge, in messages per second (msg/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "txMsgRate", skip_serializing_if="Option::is_none")]
  tx_msg_rate: Option<i64>
}

impl MsgVpnBridgeRate {
  /// The rates for the Bridge. Deprecated since 2.16. All attributes in this object have been moved to the MsgVpnBridge object.
  pub fn new() -> MsgVpnBridgeRate {
    MsgVpnBridgeRate {
  ...
  pub fn with_average_rx_byte_rate(mut self, average_rx_byte_rate: i64) -> MsgVpnBridgeRate {
    self.average_rx_byte_rate = Some(average_rx_byte_rate);
    self
  }
  ...
  pub fn with_average_rx_msg_rate(mut self, average_rx_msg_rate: i64) -> MsgVpnBridgeRate {
    self.average_rx_msg_rate = Some(average_rx_msg_rate);
    self
  }
  ...
  pub fn with_average_tx_byte_rate(mut self, average_tx_byte_rate: i64) -> MsgVpnBridgeRate {
    self.average_tx_byte_rate = Some(average_tx_byte_rate);
    self
  }
  ...
  pub fn with_average_tx_msg_rate(mut self, average_tx_msg_rate: i64) -> MsgVpnBridgeRate {
    self.average_tx_msg_rate = Some(average_tx_msg_rate);
    self
  }
  ...
  pub fn with_rx_byte_rate(mut self, rx_byte_rate: i64) -> MsgVpnBridgeRate {
    self.rx_byte_rate = Some(rx_byte_rate);
    self
  }
  ...
  pub fn with_rx_msg_rate(mut self, rx_msg_rate: i64) -> MsgVpnBridgeRate {
    self.rx_msg_rate = Some(rx_msg_rate);
    self
  }
  ...
  pub fn with_tx_byte_rate(mut self, tx_byte_rate: i64) -> MsgVpnBridgeRate {
    self.tx_byte_rate = Some(tx_byte_rate);
    self
  }
  ...
  pub fn with_tx_msg_rate(mut self, tx_msg_rate: i64) -> MsgVpnBridgeRate {
    self.tx_msg_rate = Some(tx_msg_rate);
    self
  }
