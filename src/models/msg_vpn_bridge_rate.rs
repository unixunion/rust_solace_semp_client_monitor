...
pub struct MsgVpnBridgeRate {
  /// The one minute average of the message rate received from the Bridge, in bytes per second (B/sec).
  #[serde(rename = "averageRxByteRate", skip_serializing_if="Option::is_none")]
  average_rx_byte_rate: Option<i64>,
  /// The one minute average of the message rate received from the Bridge, in messages per second (msg/sec).
  #[serde(rename = "averageRxMsgRate", skip_serializing_if="Option::is_none")]
  average_rx_msg_rate: Option<i64>,
  /// The one minute average of the message rate transmitted to the Bridge, in bytes per second (B/sec).
  #[serde(rename = "averageTxByteRate", skip_serializing_if="Option::is_none")]
  average_tx_byte_rate: Option<i64>,
  /// The one minute average of the message rate transmitted to the Bridge, in messages per second (msg/sec).
  #[serde(rename = "averageTxMsgRate", skip_serializing_if="Option::is_none")]
  average_tx_msg_rate: Option<i64>,
  /// The current message rate received from the Bridge, in bytes per second (B/sec).
  #[serde(rename = "rxByteRate", skip_serializing_if="Option::is_none")]
  rx_byte_rate: Option<i64>,
  /// The current message rate received from the Bridge, in messages per second (msg/sec).
  #[serde(rename = "rxMsgRate", skip_serializing_if="Option::is_none")]
  rx_msg_rate: Option<i64>,
  /// The current message rate transmitted to the Bridge, in bytes per second (B/sec).
  #[serde(rename = "txByteRate", skip_serializing_if="Option::is_none")]
  tx_byte_rate: Option<i64>,
  /// The current message rate transmitted to the Bridge, in messages per second (msg/sec).
