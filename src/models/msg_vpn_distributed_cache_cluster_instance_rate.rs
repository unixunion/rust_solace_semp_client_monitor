...
/// MsgVpnDistributedCacheClusterInstanceRate : The rates associated with the Cache Instance. Deprecated since 2.16. All attributes in this object have been moved to the MsgVpnDistributedCacheClusterInstance object.
...
pub struct MsgVpnDistributedCacheClusterInstanceRate {
  /// The peak of the one minute average of the data message rate received by the Cache Instance, in bytes per second (B/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "averageDataRxBytePeakRate", skip_serializing_if="Option::is_none")]
  average_data_rx_byte_peak_rate: Option<i64>,
  /// The one minute average of the data message rate received by the Cache Instance, in bytes per second (B/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "averageDataRxByteRate", skip_serializing_if="Option::is_none")]
  average_data_rx_byte_rate: Option<i64>,
  /// The peak of the one minute average of the data message rate received by the Cache Instance, in messages per second (msg/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "averageDataRxMsgPeakRate", skip_serializing_if="Option::is_none")]
  average_data_rx_msg_peak_rate: Option<i64>,
  /// The one minute average of the data message rate received by the Cache Instance, in messages per second (msg/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "averageDataRxMsgRate", skip_serializing_if="Option::is_none")]
  average_data_rx_msg_rate: Option<i64>,
  /// The peak of the one minute average of the data message rate transmitted by the Cache Instance, in messages per second (msg/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "averageDataTxMsgPeakRate", skip_serializing_if="Option::is_none")]
  average_data_tx_msg_peak_rate: Option<i64>,
  /// The one minute average of the data message rate transmitted by the Cache Instance, in messages per second (msg/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "averageDataTxMsgRate", skip_serializing_if="Option::is_none")]
  average_data_tx_msg_rate: Option<i64>,
  /// The peak of the one minute average of the request rate received by the Cache Instance, in requests per second (req/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "averageRequestRxPeakRate", skip_serializing_if="Option::is_none")]
  average_request_rx_peak_rate: Option<i64>,
  /// The one minute average of the request rate received by the Cache Instance, in requests per second (req/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "averageRequestRxRate", skip_serializing_if="Option::is_none")]
  average_request_rx_rate: Option<i64>,
  /// The data message peak rate received by the Cache Instance, in bytes per second (B/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "dataRxBytePeakRate", skip_serializing_if="Option::is_none")]
  data_rx_byte_peak_rate: Option<i64>,
  /// The data message rate received by the Cache Instance, in bytes per second (B/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "dataRxByteRate", skip_serializing_if="Option::is_none")]
  data_rx_byte_rate: Option<i64>,
  /// The data message peak rate received by the Cache Instance, in messages per second (msg/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "dataRxMsgPeakRate", skip_serializing_if="Option::is_none")]
  data_rx_msg_peak_rate: Option<i64>,
  /// The data message rate received by the Cache Instance, in messages per second (msg/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "dataRxMsgRate", skip_serializing_if="Option::is_none")]
  data_rx_msg_rate: Option<i64>,
  /// The data message peak rate transmitted by the Cache Instance, in messages per second (msg/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "dataTxMsgPeakRate", skip_serializing_if="Option::is_none")]
  data_tx_msg_peak_rate: Option<i64>,
  /// The data message rate transmitted by the Cache Instance, in messages per second (msg/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "dataTxMsgRate", skip_serializing_if="Option::is_none")]
  data_tx_msg_rate: Option<i64>,
  /// The request peak rate received by the Cache Instance, in requests per second (req/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
  #[serde(rename = "requestRxPeakRate", skip_serializing_if="Option::is_none")]
  request_rx_peak_rate: Option<i64>,
  /// The request rate received by the Cache Instance, in requests per second (req/sec). Deprecated since 2.16. This attribute has been moved to the MsgVpnDistributedCacheClusterInstance object.
...
impl MsgVpnDistributedCacheClusterInstanceRate {
  /// The rates associated with the Cache Instance. Deprecated since 2.16. All attributes in this object have been moved to the MsgVpnDistributedCacheClusterInstance object.
