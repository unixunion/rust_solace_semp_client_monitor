...
/// MsgVpnBridgeCounter : The counters for the Bridge. Deprecated since 2.16. All attributes in this object have been moved to the MsgVpnBridge object.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct MsgVpnBridgeCounter {
  /// The amount of client control messages received from the Bridge, in bytes (B). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "controlRxByteCount", skip_serializing_if="Option::is_none")]
  control_rx_byte_count: Option<i64>,
  /// The number of client control messages received from the Bridge. Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "controlRxMsgCount", skip_serializing_if="Option::is_none")]
  control_rx_msg_count: Option<i64>,
  /// The amount of client control messages transmitted to the Bridge, in bytes (B). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "controlTxByteCount", skip_serializing_if="Option::is_none")]
  control_tx_byte_count: Option<i64>,
  /// The number of client control messages transmitted to the Bridge. Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "controlTxMsgCount", skip_serializing_if="Option::is_none")]
  control_tx_msg_count: Option<i64>,
  /// The amount of client data messages received from the Bridge, in bytes (B). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "dataRxByteCount", skip_serializing_if="Option::is_none")]
  data_rx_byte_count: Option<i64>,
  /// The number of client data messages received from the Bridge. Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "dataRxMsgCount", skip_serializing_if="Option::is_none")]
  data_rx_msg_count: Option<i64>,
  /// The amount of client data messages transmitted to the Bridge, in bytes (B). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "dataTxByteCount", skip_serializing_if="Option::is_none")]
  data_tx_byte_count: Option<i64>,
  /// The number of client data messages transmitted to the Bridge. Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "dataTxMsgCount", skip_serializing_if="Option::is_none")]
  data_tx_msg_count: Option<i64>,
  /// The number of messages discarded during reception from the Bridge. Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "discardedRxMsgCount", skip_serializing_if="Option::is_none")]
  discarded_rx_msg_count: Option<i32>,
  /// The number of messages discarded during transmission to the Bridge. Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "discardedTxMsgCount", skip_serializing_if="Option::is_none")]
  discarded_tx_msg_count: Option<i32>,
  /// The number of login request messages received from the Bridge. Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "loginRxMsgCount", skip_serializing_if="Option::is_none")]
  login_rx_msg_count: Option<i64>,
  /// The number of login response messages transmitted to the Bridge. Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "loginTxMsgCount", skip_serializing_if="Option::is_none")]
  login_tx_msg_count: Option<i64>,
  /// The number of guaranteed messages received from the Bridge. Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "msgSpoolRxMsgCount", skip_serializing_if="Option::is_none")]
  msg_spool_rx_msg_count: Option<i64>,
  /// The amount of messages received from the Bridge, in bytes (B). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "rxByteCount", skip_serializing_if="Option::is_none")]
  rx_byte_count: Option<i64>,
  /// The number of messages received from the Bridge. Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "rxMsgCount", skip_serializing_if="Option::is_none")]
  rx_msg_count: Option<i32>,
  /// The amount of messages transmitted to the Bridge, in bytes (B). Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "txByteCount", skip_serializing_if="Option::is_none")]
  tx_byte_count: Option<i64>,
  /// The number of messages transmitted to the Bridge. Deprecated since 2.16. This attribute has been moved to the MsgVpnBridge object.
  #[serde(rename = "txMsgCount", skip_serializing_if="Option::is_none")]
  tx_msg_count: Option<i64>
}

impl MsgVpnBridgeCounter {
  /// The counters for the Bridge. Deprecated since 2.16. All attributes in this object have been moved to the MsgVpnBridge object.
  pub fn new() -> MsgVpnBridgeCounter {
    MsgVpnBridgeCounter {
  ...
  pub fn with_control_rx_byte_count(mut self, control_rx_byte_count: i64) -> MsgVpnBridgeCounter {
    self.control_rx_byte_count = Some(control_rx_byte_count);
    self
  }
  ...
  pub fn with_control_rx_msg_count(mut self, control_rx_msg_count: i64) -> MsgVpnBridgeCounter {
    self.control_rx_msg_count = Some(control_rx_msg_count);
    self
  }
  ...
  pub fn with_control_tx_byte_count(mut self, control_tx_byte_count: i64) -> MsgVpnBridgeCounter {
    self.control_tx_byte_count = Some(control_tx_byte_count);
    self
  }
  ...
  pub fn with_control_tx_msg_count(mut self, control_tx_msg_count: i64) -> MsgVpnBridgeCounter {
    self.control_tx_msg_count = Some(control_tx_msg_count);
    self
  }
  ...
  pub fn with_data_rx_byte_count(mut self, data_rx_byte_count: i64) -> MsgVpnBridgeCounter {
    self.data_rx_byte_count = Some(data_rx_byte_count);
    self
  }
  ...
  pub fn with_data_rx_msg_count(mut self, data_rx_msg_count: i64) -> MsgVpnBridgeCounter {
    self.data_rx_msg_count = Some(data_rx_msg_count);
    self
  }
  ...
  pub fn with_data_tx_byte_count(mut self, data_tx_byte_count: i64) -> MsgVpnBridgeCounter {
    self.data_tx_byte_count = Some(data_tx_byte_count);
    self
  }
  ...
  pub fn with_data_tx_msg_count(mut self, data_tx_msg_count: i64) -> MsgVpnBridgeCounter {
    self.data_tx_msg_count = Some(data_tx_msg_count);
    self
  }
  ...
  pub fn with_discarded_rx_msg_count(mut self, discarded_rx_msg_count: i32) -> MsgVpnBridgeCounter {
    self.discarded_rx_msg_count = Some(discarded_rx_msg_count);
    self
  }
  ...
  pub fn with_discarded_tx_msg_count(mut self, discarded_tx_msg_count: i32) -> MsgVpnBridgeCounter {
    self.discarded_tx_msg_count = Some(discarded_tx_msg_count);
    self
  }
  ...
  pub fn with_login_rx_msg_count(mut self, login_rx_msg_count: i64) -> MsgVpnBridgeCounter {
    self.login_rx_msg_count = Some(login_rx_msg_count);
    self
  }
  ...
  pub fn with_login_tx_msg_count(mut self, login_tx_msg_count: i64) -> MsgVpnBridgeCounter {
    self.login_tx_msg_count = Some(login_tx_msg_count);
    self
  }
  ...
  pub fn with_msg_spool_rx_msg_count(mut self, msg_spool_rx_msg_count: i64) -> MsgVpnBridgeCounter {
    self.msg_spool_rx_msg_count = Some(msg_spool_rx_msg_count);
    self
  }
  ...
  pub fn with_rx_byte_count(mut self, rx_byte_count: i64) -> MsgVpnBridgeCounter {
    self.rx_byte_count = Some(rx_byte_count);
    self
  }
  ...
  pub fn set_rx_msg_count(&mut self, rx_msg_count: i32) {
    self.rx_msg_count = Some(rx_msg_count);
  }

  pub fn with_rx_msg_count(mut self, rx_msg_count: i32) -> MsgVpnBridgeCounter {
    self.rx_msg_count = Some(rx_msg_count);
    self
  }

  pub fn rx_msg_count(&self) -> Option<&i32> {
  ...
  pub fn with_tx_byte_count(mut self, tx_byte_count: i64) -> MsgVpnBridgeCounter {
    self.tx_byte_count = Some(tx_byte_count);
    self
  }
  ...
  pub fn with_tx_msg_count(mut self, tx_msg_count: i64) -> MsgVpnBridgeCounter {
    self.tx_msg_count = Some(tx_msg_count);
    self
  }
