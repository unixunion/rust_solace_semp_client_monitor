...
pub struct MsgVpnQueuePriority {
...
impl MsgVpnQueuePriority {
  pub fn new() -> MsgVpnQueuePriority {
    MsgVpnQueuePriority {
      msg_vpn_name: None,
      priority: None,
      queue_name: None,
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnQueuePriority {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> MsgVpnQueuePriority {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_queue_name(mut self, queue_name: String) -> MsgVpnQueuePriority {
    self.queue_name = Some(queue_name);
    self
  }
  ...
  pub fn with_spooled_byte_count(mut self, spooled_byte_count: i64) -> MsgVpnQueuePriority {
    self.spooled_byte_count = Some(spooled_byte_count);
    self
  }
  ...
  pub fn with_spooled_msg_count(mut self, spooled_msg_count: i64) -> MsgVpnQueuePriority {
    self.spooled_msg_count = Some(spooled_msg_count);
    self
  }
