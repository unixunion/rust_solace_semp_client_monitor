...
pub struct MsgVpnTopicEndpoint {
  ...
  /// Indicates whether the respecting of message priority is enabled. When enabled, messages contained in the Topic Endpoint are delivered in priority order, from 9 (highest) to 0 (lowest).
