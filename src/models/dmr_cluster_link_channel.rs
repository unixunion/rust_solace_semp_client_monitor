...
pub struct DmrClusterLinkChannel {
...
impl DmrClusterLinkChannel {
  pub fn new() -> DmrClusterLinkChannel {
  ...
  pub fn with_bridge_name(mut self, bridge_name: String) -> DmrClusterLinkChannel {
    self.bridge_name = Some(bridge_name);
    self
  }
  ...
  pub fn with_client_name(mut self, client_name: String) -> DmrClusterLinkChannel {
    self.client_name = Some(client_name);
    self
  }
  ...
  pub fn with_dmr_cluster_name(mut self, dmr_cluster_name: String) -> DmrClusterLinkChannel {
    self.dmr_cluster_name = Some(dmr_cluster_name);
    self
  }
  ...
  pub fn set_establisher(&mut self, establisher: bool) {
    self.establisher = Some(establisher);
  }

  pub fn with_establisher(mut self, establisher: bool) -> DmrClusterLinkChannel {
    self.establisher = Some(establisher);
    self
  }

  pub fn establisher(&self) -> Option<&bool> {
  ...
  pub fn with_failure_reason(mut self, failure_reason: String) -> DmrClusterLinkChannel {
    self.failure_reason = Some(failure_reason);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> DmrClusterLinkChannel {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_queue_name(mut self, queue_name: String) -> DmrClusterLinkChannel {
    self.queue_name = Some(queue_name);
    self
  }
  ...
  pub fn with_remote_address(mut self, remote_address: String) -> DmrClusterLinkChannel {
    self.remote_address = Some(remote_address);
    self
  }
  ...
  pub fn with_remote_node_name(mut self, remote_node_name: String) -> DmrClusterLinkChannel {
    self.remote_node_name = Some(remote_node_name);
    self
  }
  ...
  pub fn with_up(mut self, up: bool) -> DmrClusterLinkChannel {
    self.up = Some(up);
    self
  }
  ...
  pub fn with_uptime(mut self, uptime: i64) -> DmrClusterLinkChannel {
    self.uptime = Some(uptime);
    self
  }
