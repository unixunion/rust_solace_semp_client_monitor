...
pub struct MsgVpnBridgeRemoteMsgVpn {
  ...
  #[serde(rename = "lastQueueBindFailureReason", skip_serializing_if="Option::is_none")]
  last_queue_bind_failure_reason: Option<String>,
  ...
  #[serde(rename = "queueBoundUptime", skip_serializing_if="Option::is_none")]
  queue_bound_uptime: Option<i32>,
  ...
  /// Indicates whether TLS encryption is enabled for the remote Message VPN connection.
...
impl MsgVpnBridgeRemoteMsgVpn {
  pub fn new() -> MsgVpnBridgeRemoteMsgVpn {
    MsgVpnBridgeRemoteMsgVpn {
      ...
      last_queue_bind_failure_reason: None,
      msg_vpn_name: None,
      queue_binding: None,
      queue_bound_uptime: None,
  ...
  pub fn with_bound_to_queue(mut self, bound_to_queue: bool) -> MsgVpnBridgeRemoteMsgVpn {
    self.bound_to_queue = Some(bound_to_queue);
    self
  }
  ...
  pub fn with_last_connection_failure_reason(mut self, last_connection_failure_reason: String) -> MsgVpnBridgeRemoteMsgVpn {
    self.last_connection_failure_reason = Some(last_connection_failure_reason);
    self
  }
  ...
  pub fn set_last_queue_bind_failure_reason(&mut self, last_queue_bind_failure_reason: String) {
    self.last_queue_bind_failure_reason = Some(last_queue_bind_failure_reason);
  }

  pub fn with_last_queue_bind_failure_reason(mut self, last_queue_bind_failure_reason: String) -> MsgVpnBridgeRemoteMsgVpn {
    self.last_queue_bind_failure_reason = Some(last_queue_bind_failure_reason);
    self
  }

  pub fn last_queue_bind_failure_reason(&self) -> Option<&String> {
    self.last_queue_bind_failure_reason.as_ref()
  }

  pub fn reset_last_queue_bind_failure_reason(&mut self) {
    self.last_queue_bind_failure_reason = None;
  }
  ...
  pub fn set_queue_bound_uptime(&mut self, queue_bound_uptime: i32) {
    self.queue_bound_uptime = Some(queue_bound_uptime);
  }

  pub fn with_queue_bound_uptime(mut self, queue_bound_uptime: i32) -> MsgVpnBridgeRemoteMsgVpn {
    self.queue_bound_uptime = Some(queue_bound_uptime);
    self
  }

  pub fn queue_bound_uptime(&self) -> Option<&i32> {
    self.queue_bound_uptime.as_ref()
  }

  pub fn reset_queue_bound_uptime(&mut self) {
    self.queue_bound_uptime = None;
  }
  ...
  pub fn with_up(mut self, up: bool) -> MsgVpnBridgeRemoteMsgVpn {
    self.up = Some(up);
    self
  }
