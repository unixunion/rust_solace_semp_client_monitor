...
**allow_shared_subscriptions_enabled** | **bool** | Enable or disable allowing shared subscriptions. | [optional] [default to null]
...
**api_queue_management_copy_from_on_create_name** | **String** | The name of a queue to copy settings from when a new queue is created by a client using the Client Profile. The referenced queue must exist in the Message VPN. | [optional] [default to null]
**api_topic_endpoint_management_copy_from_on_create_name** | **String** | The name of a topic endpoint to copy settings from when a new topic endpoint is created by a client using the Client Profile. The referenced topic endpoint must exist in the Message VPN. | [optional] [default to null]
...
**max_egress_flow_count** | **i64** | The maximum number of transmit flows per client using the Client Profile. | [optional] [default to null]
**max_endpoint_count_per_client_username** | **i64** | The maximum number of queues and topic endpoints per Client Username using the Client Profile. | [optional] [default to null]
**max_ingress_flow_count** | **i64** | The maximum number of receive flows per client using the Client Profile. | [optional] [default to null]
...
**max_transacted_session_count** | **i64** | The maximum number of transacted sessions per client using the Client Profile. | [optional] [default to null]
**max_transaction_count** | **i64** | The maximum number of transactions per client using the Client Profile. | [optional] [default to null]
