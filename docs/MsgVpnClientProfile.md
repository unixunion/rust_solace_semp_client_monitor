...
**allow_shared_subscriptions_enabled** | **bool** | Enable or disable allowing shared subscriptions. Changing this setting does not affect existing subscriptions. | [optional] [default to null]
