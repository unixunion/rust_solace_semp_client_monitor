...
**consumer_ack_propagation_enabled** | **bool** | Enable or disable the propagation of consumer acknowledgements (ACKs) received on the active replication Message VPN to the standby replication Message VPN. | [optional] [default to null]
...
**egress_enabled** | **bool** | Enable or disable the transmission of messages from the Topic Endpoint. | [optional] [default to null]
