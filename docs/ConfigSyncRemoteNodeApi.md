...
------------- | ------------- | -------------
[**get_msg_vpn_config_sync_remote_nodes**](ConfigSyncRemoteNodeApi.md#get_msg_vpn_config_sync_remote_nodes) | **Get** /msgVpns/{msgVpnName}/configSyncRemoteNodes | Get a list of Config Sync Remote Node objects.
