...
**egress_enabled** | **bool** | Enable or disable the transmission of messages from the Queue. | [optional] [default to null]
...
**ingress_enabled** | **bool** | Enable or disable the reception of messages to the Queue. | [optional] [default to null]
...
**respect_msg_priority_enabled** | **bool** | Indicates whether the respecting of message priority is enabled. When enabled, messages contained in the Queue are delivered in priority order, from 9 (highest) to 0 (lowest). | [optional] [default to null]
**respect_ttl_enabled** | **bool** | Enable or disable the respecting of the time-to-live (TTL) for messages in the Queue. When enabled, expired messages are discarded or moved to the DMQ. | [optional] [default to null]
